...
#include <SPI.h>
#include <SD.h>
#include "System/Net/Bluetooth.hpp"
...
void setup()
{
	...
	myFile = SD.open("ASDF/test.txt", FILE_WRITE); // 두 번째 인자가 있으면 쓰기모드입니다.
	...
	myFile = SD.open("ASDF/test.txt", FILE_READ);
